...
export LD_LIBRARY_PATH=/opt/ovis/lib64/:$LD_LIBRARY_PATH
export LD_PRELOAD=/projects/darshan/install/lib/libdarshan.so:/opt/intel/2020.4.912/lib/intel64/libimf.so
...
#export DARSHAN_LDMS_HOST=nid00046
